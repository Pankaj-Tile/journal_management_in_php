...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->execute([$username, $email, $password, $role, $profile_image]);
...
<div class="custom-form-container">
    <h2 class="custom-form-header">Register</h2>
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="custom-form-group">
            ...
            <select class="custom-form-control" id="role" name="role" required>
