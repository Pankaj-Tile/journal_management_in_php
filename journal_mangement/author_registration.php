...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['role'] === 'author') {
    ...
    $stmt->execute([$username, $email, $password, 'author', $profile_image]);
...
<div class="custom-form-container">
    <h2 class="custom-form-header">Author Registration</h2>
